...
export const allItems: Item[] = [
    // --- 食料・水 ---
    { id: 1, name: '水', description: '1.5L 生命維持に不可欠。水分補給の基本です。', image: '/images/水.png', category: 'food', effects: {}, resourceType: 'water', resourceAmount: 3000, foodCategory: 'nutrition' },
    ...
    { id: 25, name: 'フリーズドライ', description: '3食分。お湯を注ぐだけで温かい食事ができます。', image: '/images/フリーズドライ.png', category: 'food', effects: {}, heatable: true, heatingCost: { gas: 1, water: 150 }, heatedEffects: { satiety: 5, morale: 3 }, foodCategory: 'side', nutritionEffect: 0, maxUses: 3 },

    // --- 衛生用品 ---
    { id: 5, name: '救急セット', description: '絆創膏、消毒液など。怪我の応急手当に必須です。', image: '/images/救急セット.png', category: 'hygiene', effects: {}, maxUses: 3},
    ...
    { id: 21, name: '歯みがき用ウェットティッシュ', description: '30枚(9回分)　水なしで歯をきれいにできます。爽快感も得られます。', image: '/images/歯磨きティッシュ.png', category: 'hygiene', effects: { hygiene: 4, morale: 2 }, maxUses: 9 ,resourceAmount: 30 },
    ...
    { id: 24, 'name': 'LEDランタン', 'description': '3台分。停電時の夜の明かり。安全確保と不安の軽減に。', image: '/images/ランタン.png', category: 'lifeline', effects: {} ,resourceAmount: 3 },
    { id: 26, name: 'ラップ', description: '食器に被せたり、体に巻いて保温したりと多用途に使えます。', image: '/images/ラップ.png', category: 'lifeline', effects: {} },
    { id: 27, name: 'ポリ袋', description: '水の運搬、ごみ袋、調理、応急手当など幅広く活躍します。', image: '/images/ポリ袋.png', category: 'lifeline', effects: {} },
