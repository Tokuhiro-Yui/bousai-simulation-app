...
const recommendedItems = [
    ...
    { id: 'item_13', category: 'food', name: 'レトルト食品', recommendedQuantity: '3', unit: '個', description: '栄養バランスを考えて', importance: '調理不要のバラエティーに富んだレトルト食品。災害時は栄養バランスが偏りがちなので、たんぱく質が取れるお肉やお魚を使ったものを選びましょう。', simulated: true },
    ...
    { id: 'item_14', category: 'food', name: '栄養補助食品', recommendedQuantity: '3', unit: '箱', description: '手軽に栄養補給', importance: '食料不足になる災害時は、必要な栄養を食材で取れるとは限りません。サプリメントのほか、必要な栄養が詰まったバランス栄養食は、災害時、十分な調理ができないときでも手軽に栄養補給できます。', simulated: true },
    ...
    { id: 'item_extra_food_1', category: 'food', name: 'フリーズドライ食品', image: '/images/フリーズドライ.png', recommendedQuantity: '3', unit: '個', description: '味噌汁、スープなど', importance: 'フリーズドライ食品は、少量のお湯で食べられ、災害時に不足しがちな野菜の栄養素が取れます。スープなので摂取しやすく副菜として用意しておくと有効です。たくさんの種類がありおいしいので普段の生活の中で定期的に食べながら、自分が好きな味のものをストックしましょう。', simulated: false },
    { id: 'item_extra_food_2', category: 'food', name: '健康飲料粉末', image: '/images/粉末飲料.png', recommendedQuantity: '3', unit: '袋', description: 'スポーツドリンクの粉末など', importance: '食料不足になる災害時は、必要な栄養を食材で取れるとは限りません。サプリメントのほか健康飲料の粉末などは、調理ができないときや疲れて食べ物がのどを通らないときでも、手軽に栄養補給できます。', simulated: false },
    ...
    // --- 衛生用品 ---
    { id: 'item_6', category: 'hygiene', name: '携帯トイレ・簡易トイレ', recommendedQuantity: '15', unit: '回分', description: '断水時の必需品', importance: '断水するとトイレは流せません。水が使えたとしても、集合住宅で配관が破損していた場合、汚水が逆流し下階のトイレからあふれる可能性もあります。トイレを我慢するために、食事や水を飲む量を減らすと、健康状態の悪化にもつながるので、家庭の便器に設置して固めて処理できる携帯トイレ・簡易トイレを用意しましょう。', simulated: true },
    ...
    { id: 'item_5', category: 'hygiene', name: '救急箱', recommendedQuantity: '1', unit: '箱', description: '応急手当用品', importance: '災害時に備えて応急手当用品があると安心です。ばんそうこうやガーゼ、包帯、ピンセット、綿棒、爪切り、体温計、マスクなどを救急箱に備えておきましょう。', simulated: true },
    { id: 'item_21', category: 'hygiene', name: '歯みがき用ウェットティッシュ', recommendedQuantity: '30', unit: '枚程度', description: '口腔ケアで感染症予防', importance: '断水により歯磨きができず口の中が不衛生になると、免疫力の低い高齢者や小さな子供は肺炎などの感染症にかかりやすくなります。歯みがき用のウェットティッシュでこまめに歯を拭き、口の中をきれいに保ちましょう。アルコールフリーなのでボディケアや食器拭きにも使えます。', simulated: true },
    ...
    { id: 'item_extra_hygiene_4', category: 'hygiene', name: '常備薬', image: '/images/常備薬.png', recommendedQuantity: '適宜', unit: '', description: '持病の薬や鎮痛剤など', importance: '軽い症状のときや、医師にかかるまでの応急的な処置を行うときに使えます。薬は災害時に手に入りにくくなるので、鎮痛薬、胃腸薬、風邪薬など、必要なものを揃えておきましょう。', simulated: false },
    ...
    { id: 'item_extra_hygiene_2', category: 'hygiene', name: 'アルコールスプレー', image: '/images/アルコールスプレー.png', recommendedQuantity: '1', unit: '本', description: '手指の消毒に', importance: '水道が止まっている時の手洗いや食器を拭くのに活用します。アルコールには消臭効果もあるため、ニオイが気になるところに吹きかけるといった使い方もできます。さらに、現在のコロナ禍での感染症対策としても効果を発揮します。', simulated: false },
    { id: 'item_extra_hygiene_3', category: 'hygiene', name: '使い捨てコンタクトレンズ', image: '/images/コンタクト.png', recommendedQuantity: '1人1か月分', unit: '', description: '衛生的な視力確保', importance: '災害時にはきれいな水が手に入らず、消毒ができない場合があります。そんな時、使い捨てのコンタクトレンズがあると便利です。予備として眼鏡の用意があるとなおよいでしょう。', simulated: false },
    ...
    { id: 'item_extra_lifeline_18', category: 'lifeline', name: '懐中電灯', image: '/images/懐中電灯.png', recommendedQuantity: '1', unit: '灯', description: '移動時の照明', importance: '夜間に災害が発生して停電した場合、家具やガラスが散乱した状態で部屋を歩くことは非常に危険です。誤ってけがをしてしまえば、自宅で生活ができなくなるおそれも。部屋の照明としては、ランタンも効果的です。', simulated: false },
    { id: 'item_extra_lifeline_4', category: 'lifeline', name: '乾電池', image: '/images/乾電池.png', recommendedQuantity: '1', unit: 'セット', description: '単1～単4まで', importance: '懐中電灯などを用意しても電池がなければ使うことができません。また、電池は突然切れるおそれもあります。災害時は電池の使用頻度も高まるので、少し多めに買いそろえ、使いながら買い足す、日常備蓄（ローリングストック）の一環として備えておきましょう。', simulated: false },
    { id: 'item_extra_lifeline_1', category: 'lifeline', name: 'ラップ', image: '/images/ラップ.png', recommendedQuantity: '1', unit: '本', description: '多用途に使える', importance: '断水時、食器に被せれば汚れを防ぎ、洗わずに済みます。また、三角巾や包帯代わりにも使え、体に巻けば保温効果も期待できます。', simulated: false },
    { id: 'item_extra_lifeline_2', category: 'lifeline', name: 'ポリ袋', image: '/images/ポリ袋.png', recommendedQuantity: '1', unit: '箱', description: '多用途に使える', importance: '手に被せると応急手当時の感染防止に役立ちます。断水時には食材を入れて調理すれば衛生的です。ジッパー付きの袋はニオイの防止になるので、トイレごみなどは黒いごみ袋に入れジッパー付きの袋に入れましょう。', simulated: false },
    { id: 'item_extra_lifeline_19', category: 'lifeline', name: 'ビニール手袋', image: '/images/ビニール手袋.png', recommendedQuantity: '1', unit: '箱', description: '衛生的な調理に', importance: '手がしっかり洗えない状態で調理をしなければならない時に、ラテックス製などの使い捨てができる手袋があると便利です。トイレ掃除など、不衛生な物を扱う時にも役立ちます。', simulated: false },
    { id: 'item_extra_lifeline_16', category: 'lifeline', name: 'アルミホイル', image: '/images/アルミホイル.png', recommendedQuantity: '1', unit: '本', description: '調理や食器代わりに', importance: '断水時、調理器具にアルミホイルを敷くと汚さずに調理できます。また、お皿の形にすれば、使い捨ての食器としても使えます。ニオイを通さないので、防臭にも役立ちます。', simulated: false },
    { id: 'item_extra_lifeline_14', category: 'lifeline', name: 'トイレットペーパー', image: '/images/トイレットペーパー.png', recommendedQuantity: '1', unit: 'ロール', description: 'ティッシュの代わりにも', importance: '断水が起きなくても、トイレットペーパーがなければトイレが使えません。切らすと不便で、トイレへの不安がますます強くなってしまいます。ティッシュペーパーの代わりとしても使えます。', simulated: false },
    { id: 'item_extra_lifeline_6', category: 'lifeline', name: '給水袋', image: '/images/給水袋.png', recommendedQuantity: '1', unit: '袋', description: '水の運搬に', importance: '水道が復旧しない状況で、給水車に水をもらいに行くときに活用します。', simulated: false },
    { id: 'item_extra_lifeline_20', category: 'lifeline', name: 'リュックサック', image: '/images/リュック.png', recommendedQuantity: '1', unit: '個', description: '水の運搬に', importance: '断水時には給水拠点などから水を運ぶ必要も出てきます。もし災害時にエレベーターが止まり、階段を使って運ばないといけないときは、リュックに大きめのポリ袋を被せ、その中に水を入れて運べば、ポリタンクよりも楽に運べます。', simulated: false },
    { id: 'item_extra_lifeline_8', category: 'lifeline', name: '使い捨てカイロ', image: '/images/カイロ.png', recommendedQuantity: '6', unit: '個', description: '冬の寒さ対策', importance: '寒いときの定番「カイロ」。冬の外出時、かばんの中に入れておくと、エレベーターに閉じ込められたときなどでも体を温めて生命維持につながります。カイロでレトルト食材を挟み、アルミブランケットやタオルで包めば、レトルト食品を温めることもできます。', simulated: false },
    { id: 'item_extra_lifeline_12', category: 'lifeline', name: '新聞紙', image: '/images/新聞紙.png', recommendedQuantity: '適宜', unit: '', description: '防寒やトイレ処理に', importance: '新聞紙には保温効果があるため、体に巻いて温めることが可能です。水分を良く吸い、防臭効果もあるため、断水時のトイレ処理にも活用できます。', simulated: false },
];
...
export default function ResultPage() {
  ...
  const survivedDays = turnCount >= totalTurns ? 3 : Math.floor(turnCount / 3) + 1;
    ...
    <div className="bg-slate-50 min-h-screen font-sans text-gray-800">
      <main className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <section className="bg-white p-6 rounded-2xl shadow-lg mb-8">
          ...
          <p className="text-center font-semibold text-lg text-gray-700 mb-4">あなたは {survivedDays} 日間、避難生活を送ることができました。</p>
        ...
        <section className="bg-white p-6 rounded-2xl shadow-lg mb-8">
          <h2 className="text-2xl font-semibold mb-6">備蓄品の過不足チェック (3日分)</h2>
                        ...
                        if (details.resourceType === 'water') {
                          ...
                          userQuantity = (details.resourceAmount || 0) * selected.quantity / 1000;
                            ...
                            if (itemId === 20) {
                                ...
                                userQuantity = details.maxUses * selected.quantity;
                            }
                        } else {
                          userQuantity = selected.quantity;
                        }
                      }
                    }
