...
const recommendedItems = [
    ...
    { id: 'item_30', category: 'lifeline', name: '布製ガムテープ', image: '/images/ガムテープ.png', recommendedQuantity: '1', unit: '個', description: '補修や固定に', importance: '物の補修、固定、メモ書き、応急手当など、万能なテープ。', simulated: true },
